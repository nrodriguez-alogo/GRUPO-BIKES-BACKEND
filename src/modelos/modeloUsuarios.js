...
const esquemaUsuarios = new Schema({
    ...
    rol: { type: String, required: true, enum:['administrador', 'usuario'], default:'usuario', set:v => 
        {const allowedroles = ['administrador', 'usuario']; if (!v || v.trim() === '' || !allowedroles.includes(v)) {return 'usuario'}return v}
    }
});
